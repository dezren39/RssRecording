...
Public Class RssSingleForm
    ...
    Dim selectedStory As Story
    Dim storyList As New BindingList(Of Story)
    ...
    Private Sub LblMod_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
